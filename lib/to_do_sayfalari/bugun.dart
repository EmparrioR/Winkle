...
class _BugunState extends State<Bugun> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Bugün', style: TextStyle(color: Colors.black)),
        backgroundColor: Colors.green,
      ),
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            ...
            image: NetworkImage(
                "https://images.unsplash.com/photo-1559770968-53924e9b32de?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=327&q=80"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
